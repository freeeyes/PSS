...
ProjectPath            :=/data/develop/Lib/Network/PSS-master/purenessscopeserver/example-Module/KafkaClient
...
$(OutputFile): $(IntermediateDirectory)/.d $(Objects) 
	...
	@echo rebuilt > "/data/develop/Lib/Network/PSS-master/Build/Linux/.build-release/KafkaClient"
...
$(IntermediateDirectory)/KafkaClient_BaseCommand.cpp$(ObjectSuffix): ./KafkaClient/BaseCommand.cpp $(IntermediateDirectory)/KafkaClient_BaseCommand.cpp$(DependSuffix)
	$(CXX) $(IncludePCH) $(SourceSwitch) "/data/develop/Lib/Network/PSS-master/purenessscopeserver/example-Module/KafkaClient/KafkaClient/BaseCommand.cpp" $(CXXFLAGS) $(ObjectSwitch)$(IntermediateDirectory)/KafkaClient_BaseCommand.cpp$(ObjectSuffix) $(IncludePath)
...
$(IntermediateDirectory)/KafkaClient_kafkaTest.cpp$(ObjectSuffix): ./KafkaClient/kafkaTest.cpp $(IntermediateDirectory)/KafkaClient_kafkaTest.cpp$(DependSuffix)
	$(CXX) $(IncludePCH) $(SourceSwitch) "/data/develop/Lib/Network/PSS-master/purenessscopeserver/example-Module/KafkaClient/KafkaClient/kafkaTest.cpp" $(CXXFLAGS) $(ObjectSwitch)$(IntermediateDirectory)/KafkaClient_kafkaTest.cpp$(ObjectSuffix) $(IncludePath)
...
$(IntermediateDirectory)/KafkaClient_KafkaClient.cpp$(ObjectSuffix): ./KafkaClient/KafkaClient.cpp $(IntermediateDirectory)/KafkaClient_KafkaClient.cpp$(DependSuffix)
	$(CXX) $(IncludePCH) $(SourceSwitch) "/data/develop/Lib/Network/PSS-master/purenessscopeserver/example-Module/KafkaClient/KafkaClient/KafkaClient.cpp" $(CXXFLAGS) $(ObjectSwitch)$(IntermediateDirectory)/KafkaClient_KafkaClient.cpp$(ObjectSuffix) $(IncludePath)
