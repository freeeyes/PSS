...
ProjectPath            :=/data/develop/Lib/Network/PSS-master/purenessscopeserver/example-Module/WebSocket
...
$(OutputFile): $(IntermediateDirectory)/.d $(Objects) 
	...
	@echo rebuilt > "/data/develop/Lib/Network/PSS-master/Build/Linux/.build-release/WebSocket"
...
$(IntermediateDirectory)/WebSocket_BaseCommand.cpp$(ObjectSuffix): ./WebSocket/BaseCommand.cpp $(IntermediateDirectory)/WebSocket_BaseCommand.cpp$(DependSuffix)
	$(CXX) $(IncludePCH) $(SourceSwitch) "/data/develop/Lib/Network/PSS-master/purenessscopeserver/example-Module/WebSocket/WebSocket/BaseCommand.cpp" $(CXXFLAGS) $(ObjectSwitch)$(IntermediateDirectory)/WebSocket_BaseCommand.cpp$(ObjectSuffix) $(IncludePath)
...
$(IntermediateDirectory)/WebSocket_base64.cpp$(ObjectSuffix): ./WebSocket/base64.cpp $(IntermediateDirectory)/WebSocket_base64.cpp$(DependSuffix)
	$(CXX) $(IncludePCH) $(SourceSwitch) "/data/develop/Lib/Network/PSS-master/purenessscopeserver/example-Module/WebSocket/WebSocket/base64.cpp" $(CXXFLAGS) $(ObjectSwitch)$(IntermediateDirectory)/WebSocket_base64.cpp$(ObjectSuffix) $(IncludePath)
...
$(IntermediateDirectory)/WebSocket_WebSocketTest.cpp$(ObjectSuffix): ./WebSocket/WebSocketTest.cpp $(IntermediateDirectory)/WebSocket_WebSocketTest.cpp$(DependSuffix)
	$(CXX) $(IncludePCH) $(SourceSwitch) "/data/develop/Lib/Network/PSS-master/purenessscopeserver/example-Module/WebSocket/WebSocket/WebSocketTest.cpp" $(CXXFLAGS) $(ObjectSwitch)$(IntermediateDirectory)/WebSocket_WebSocketTest.cpp$(ObjectSuffix) $(IncludePath)
...
$(IntermediateDirectory)/WebSocket_sha1.cpp$(ObjectSuffix): ./WebSocket/sha1.cpp $(IntermediateDirectory)/WebSocket_sha1.cpp$(DependSuffix)
	$(CXX) $(IncludePCH) $(SourceSwitch) "/data/develop/Lib/Network/PSS-master/purenessscopeserver/example-Module/WebSocket/WebSocket/sha1.cpp" $(CXXFLAGS) $(ObjectSwitch)$(IntermediateDirectory)/WebSocket_sha1.cpp$(ObjectSuffix) $(IncludePath)
