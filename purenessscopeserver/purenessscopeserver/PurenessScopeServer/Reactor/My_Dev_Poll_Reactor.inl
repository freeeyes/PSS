...
ACE_INLINE
My_ACE_Dev_Poll_Reactor::Event_Tuple::Event_Tuple (ACE_Event_Handler *eh,
                                                ACE_Reactor_Mask m,
                                                bool is_suspended,
                                                bool is_controlled)
  : event_handler (eh),
...
ACE_INLINE
My_ACE_Dev_Poll_Handler_Guard::My_ACE_Dev_Poll_Handler_Guard
...
ACE_INLINE
My_ACE_Dev_Poll_Handler_Guard::~My_ACE_Dev_Poll_Handler_Guard (void)
{
...
ACE_INLINE void
My_ACE_Dev_Poll_Handler_Guard::release (void)
{
  this->eh_ = 0;
}
