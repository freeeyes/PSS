...
#ifndef _MY_ACE_DEV_POLL_REACTOR_H
#define _MY_ACE_DEV_POLL_REACTOR_H
...
class ACE_Export My_ACE_Dev_Poll_Reactor : public ACE_Reactor_Impl
{

	/**
	* @struct My_Event_Tuple
	*
	...
	*/
	struct My_Event_Tuple
	{
		...
		My_Event_Tuple (ACE_Event_Handler *eh = 0,
	...
	* @internal
	*
	* @brief Used to map ACE_HANDLEs onto the appropriate My_Event_Tuple.
	*
	...
	*       My_Event_Tuple returned from this class's methods, must be made
	...
	*/
	...
	public:
		...
		*/
		...
		/// Return a pointer to the My_Event_Tuple associated with @a handle.
		/// If there is none associated, returns 0 and sets errno.
		My_Event_Tuple *find (ACE_HANDLE handle);
...
*/
class MyACE_Dev_Poll_Handler_Guard
{
public:
	...
	*/
	MyACE_Dev_Poll_Handler_Guard (ACE_Event_Handler *eh, bool do_incr = true);
	...
	*/
	~MyACE_Dev_Poll_Handler_Guard (void);
