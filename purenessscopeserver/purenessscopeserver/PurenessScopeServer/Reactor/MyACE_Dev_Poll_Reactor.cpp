...
# include "MyACE_Dev_Poll_Reactor.inl"

ACE_BEGIN_VERSIONED_NAMESPACE_DECL

My_ACE_Dev_Poll_Reactor_Notify::My_ACE_Dev_Poll_Reactor_Notify (void)
: dp_reactor_ (0)
, notification_pipe_ ()
...
int
My_ACE_Dev_Poll_Reactor_Notify::open (ACE_Reactor_Impl *r,
								   ACE_Timer_Queue * /* timer_queue */,
								   int disable_notify_pipe)
{
	ACE_TRACE ("My_ACE_Dev_Poll_Reactor_Notify::open");

	if (disable_notify_pipe == 0)
	{
		this->dp_reactor_ = dynamic_cast<My_ACE_Dev_Poll_Reactor *> (r);
...
int
My_ACE_Dev_Poll_Reactor_Notify::close (void)
{
	ACE_TRACE ("My_ACE_Dev_Poll_Reactor_Notify::close");
...
int
My_ACE_Dev_Poll_Reactor_Notify::notify (ACE_Event_Handler *eh,
									 ACE_Reactor_Mask mask,
									 ACE_Time_Value *timeout)
{
	ACE_TRACE ("My_ACE_Dev_Poll_Reactor_Notify::notify");

	// Just consider this method a "no-op" if there's no
	// My_ACE_Dev_Poll_Reactor configured.
	if (this->dp_reactor_ == 0)
		return 0;
	...
	MyACE_Dev_Poll_Handler_Guard eh_guard (eh);
...
int
My_ACE_Dev_Poll_Reactor_Notify::dispatch_notifications (
	int & /* number_of_active_handles */,
	ACE_Handle_Set & /* rd_mask */)
{
	ACE_TRACE ("My_ACE_Dev_Poll_Reactor_Notify::dispatch_notifications");

	// This method is unimplemented in the My_ACE_Dev_Poll_Reactor.
	...
	// My_ACE_Dev_Poll_Reactor.

	ACE_NOTSUP_RETURN (-1);
}

int
My_ACE_Dev_Poll_Reactor_Notify::read_notify_pipe (ACE_HANDLE handle,
											   ACE_Notification_Buffer &buffer)
{
	ACE_TRACE ("My_ACE_Dev_Poll_Reactor_Notify::read_notify_pipe");
...
int
My_ACE_Dev_Poll_Reactor_Notify::handle_input (ACE_HANDLE /*handle*/)
{
	ACE_TRACE ("My_ACE_Dev_Poll_Reactor_Notify::handle_input");
	ACELIB_ERROR_RETURN ((LM_ERROR, ACE_TEXT ("SHOULD NOT BE HERE.\n")), -1);
}

ACE_HANDLE
My_ACE_Dev_Poll_Reactor_Notify::notify_handle (void)
{
	ACE_TRACE ("My_ACE_Dev_Poll_Reactor_Notify::notify_handle");

	return this->notification_pipe_.read_handle ();
}

int
My_ACE_Dev_Poll_Reactor_Notify::is_dispatchable (ACE_Notification_Buffer &)
{
	ACE_TRACE ("My_ACE_Dev_Poll_Reactor_Notify::is_dispatchable");

	ACE_NOTSUP_RETURN (-1);
}

int
My_ACE_Dev_Poll_Reactor_Notify::dispatch_notify (ACE_Notification_Buffer &buffer)
{
	ACE_TRACE ("My_ACE_Dev_Poll_Reactor_Notify::dispatch_notify");

	// If eh == 0 then another thread is unblocking the
	// My_ACE_Dev_Poll_Reactor to update the My_ACE_Dev_Poll_Reactor's
	...
	if (buffer.eh_ != 0)
	{
		...
		MyACE_Dev_Poll_Handler_Guard eh_guard (buffer.eh_, false);
...
void
My_ACE_Dev_Poll_Reactor_Notify::max_notify_iterations (int iterations)
{
	ACE_TRACE ("My_ACE_Dev_Poll_Reactor_Notify::max_notify_iterations");
...
int
My_ACE_Dev_Poll_Reactor_Notify::max_notify_iterations (void)
{
	ACE_TRACE ("My_ACE_Dev_Poll_Reactor_Notify::max_notify_iterations");
...
int
My_ACE_Dev_Poll_Reactor_Notify::purge_pending_notifications (
	ACE_Event_Handler *eh,
	ACE_Reactor_Mask mask)
{
	ACE_TRACE ("My_ACE_Dev_Poll_Reactor_Notify::purge_pending_notifications");
...
void
My_ACE_Dev_Poll_Reactor_Notify::dump (void) const
{
#if defined (ACE_HAS_DUMP)
	ACE_TRACE ("My_ACE_Dev_Poll_Reactor_Notify::dump");
...
int
My_ACE_Dev_Poll_Reactor_Notify::dequeue_one (ACE_Notification_Buffer &nb)
{
	nb.eh_ = 0;
	nb.mask_ = 0;
...
My_ACE_Dev_Poll_Reactor::Handler_Repository::Handler_Repository (void)
: size_ (0),
max_size_ (0),
handlers_ (0)
{
	ACE_TRACE ("My_ACE_Dev_Poll_Reactor::Handler_Repository::Handler_Repository");
}

bool
My_ACE_Dev_Poll_Reactor::Handler_Repository::invalid_handle (
	ACE_HANDLE handle) const
{
	ACE_TRACE ("My_ACE_Dev_Poll_Reactor::Handler_Repository::invalid_handle");
...
bool
My_ACE_Dev_Poll_Reactor::Handler_Repository::handle_in_range (
	ACE_HANDLE handle) const
{
	ACE_TRACE ("My_ACE_Dev_Poll_Reactor::Handler_Repository::handle_in_range");
...
int
My_ACE_Dev_Poll_Reactor::Handler_Repository::open (size_t size)
{
	ACE_TRACE ("My_ACE_Dev_Poll_Reactor::Handler_Repository::open");

	this->max_size_ = size;

	// Try to allocate the memory.
	ACE_NEW_RETURN (this->handlers_, My_Event_Tuple[size], -1);
...
int
My_ACE_Dev_Poll_Reactor::Handler_Repository::unbind_all (void)
{
	ACE_TRACE ("My_ACE_Dev_Poll_Reactor::Handler_Repository::unbind_all");
	...
	for (int handle = 0;
		...
		++handle)
	{
		My_Event_Tuple *entry = this->find (handle);
		if (entry == 0)
			continue;
...
int
My_ACE_Dev_Poll_Reactor::Handler_Repository::close (void)
{
	ACE_TRACE ("My_ACE_Dev_Poll_Reactor::Handler_Repository::close");
...
My_ACE_Dev_Poll_Reactor::My_Event_Tuple *
My_ACE_Dev_Poll_Reactor::Handler_Repository::find (ACE_HANDLE handle)
{
	ACE_TRACE ("My_ACE_Dev_Poll_Reactor::Handler_Repository::find");

	My_Event_Tuple *tuple = 0;
...
int
My_ACE_Dev_Poll_Reactor::Handler_Repository::bind (
	ACE_HANDLE handle,
	ACE_Event_Handler *event_handler,
	ACE_Reactor_Mask mask)
{
	ACE_TRACE ("My_ACE_Dev_Poll_Reactor::Handler_Repository::bind");
...
int
My_ACE_Dev_Poll_Reactor::Handler_Repository::unbind (ACE_HANDLE handle,
												  bool decr_refcnt)
{
	ACE_TRACE ("My_ACE_Dev_Poll_Reactor::Handler_Repository::unbind");
...
My_ACE_Dev_Poll_Reactor::My_ACE_Dev_Poll_Reactor (ACE_Sig_Handler *sh,
											ACE_Timer_Queue *tq,
											int disable_notify_pipe,
											...
											, restart_ (0)
{
	ACE_TRACE ("My_ACE_Dev_Poll_Reactor::My_ACE_Dev_Poll_Reactor");
	...
	if (this->open (ACE::max_handles (),
		...
		ACELIB_ERROR ((LM_ERROR,
		ACE_TEXT ("%p\n"),
		ACE_TEXT ("My_ACE_Dev_Poll_Reactor::open ")
		ACE_TEXT ("failed inside ")
		ACE_TEXT ("My_ACE_Dev_Poll_Reactor::CTOR")));
}

My_ACE_Dev_Poll_Reactor::My_ACE_Dev_Poll_Reactor (size_t size,
											bool rs,
											ACE_Sig_Handler *sh,
											ACE_Timer_Queue *tq,
											int disable_notify_pipe,
											...
											, restart_ (0)
{
	if (this->open (size,
		...
		ACE_TEXT ("%p\n"),
		ACE_TEXT ("My_ACE_Dev_Poll_Reactor::open ")
		ACE_TEXT ("failed inside My_ACE_Dev_Poll_Reactor::CTOR")));
}

My_ACE_Dev_Poll_Reactor::~My_ACE_Dev_Poll_Reactor (void)
{
	ACE_TRACE ("My_ACE_Dev_Poll_Reactor::~My_ACE_Dev_Poll_Reactor");
...
int
My_ACE_Dev_Poll_Reactor::open (size_t size,
							bool restart,
							ACE_Sig_Handler *sh,
							ACE_Timer_Queue *tq,
							int disable_notify_pipe,
							ACE_Reactor_Notify *notify)
{
	ACE_TRACE ("My_ACE_Dev_Poll_Reactor::open");
	...
	if (result != -1 && this->notify_handler_ == 0)
	{
		ACE_NEW_RETURN (this->notify_handler_,
			My_ACE_Dev_Poll_Reactor_Notify,
			-1);
...
int
My_ACE_Dev_Poll_Reactor::current_info (ACE_HANDLE, size_t & /* size */)
{
	ACE_NOTSUP_RETURN (-1);
}
...
int
My_ACE_Dev_Poll_Reactor::set_sig_handler (ACE_Sig_Handler *signal_handler)
{
...
int
My_ACE_Dev_Poll_Reactor::timer_queue (ACE_Timer_Queue *tq)
{
...
ACE_Timer_Queue *
My_ACE_Dev_Poll_Reactor::timer_queue (void) const
{
	return this->timer_queue_;
}

int
My_ACE_Dev_Poll_Reactor::close (void)
{
	ACE_TRACE ("My_ACE_Dev_Poll_Reactor::close");
...
int
My_ACE_Dev_Poll_Reactor::work_pending (const ACE_Time_Value & max_wait_time)
{
	ACE_TRACE ("My_ACE_Dev_Poll_Reactor::work_pending");
...
int
My_ACE_Dev_Poll_Reactor::work_pending_i (ACE_Time_Value * max_wait_time)
{
	ACE_TRACE ("My_ACE_Dev_Poll_Reactor::work_pending_i");
...
int
My_ACE_Dev_Poll_Reactor::handle_events (ACE_Time_Value *max_wait_time)
{
	ACE_TRACE ("My_ACE_Dev_Poll_Reactor::handle_events");
...
int
My_ACE_Dev_Poll_Reactor::handle_events_i (ACE_Time_Value *max_wait_time,
									   Token_Guard &guard)
{
	ACE_TRACE ("My_ACE_Dev_Poll_Reactor::handle_events_i");
...
int
My_ACE_Dev_Poll_Reactor::dispatch (Token_Guard &guard)
{
	ACE_TRACE ("My_ACE_Dev_Poll_Reactor::dispatch");
...
int
My_ACE_Dev_Poll_Reactor::dispatch_timer_handler (Token_Guard &guard)
{
...
#if 0
int
My_ACE_Dev_Poll_Reactor::dispatch_notification_handlers (
	...
	int &number_of_handlers_dispatched)
{
	...
	// My_ACE_Dev_Poll_Reactor's internal tables or the notify pipe is
...
int
My_ACE_Dev_Poll_Reactor::dispatch_io_event (Token_Guard &guard)
{
...
int
My_ACE_Dev_Poll_Reactor::alertable_handle_events (ACE_Time_Value *max_wait_time)
{
	ACE_TRACE ("My_ACE_Dev_Poll_Reactor::alertable_handle_events");
...
int
My_ACE_Dev_Poll_Reactor::deactivated (void)
{
	return this->deactivated_;
}

void
My_ACE_Dev_Poll_Reactor::deactivate (int do_stop)
{
...
int
My_ACE_Dev_Poll_Reactor::register_handler (ACE_Event_Handler *handler,
										ACE_Reactor_Mask mask)
{
	ACE_TRACE ("My_ACE_Dev_Poll_Reactor::register_handler");
...
int
My_ACE_Dev_Poll_Reactor::register_handler (ACE_HANDLE handle,
										ACE_Event_Handler *event_handler,
										ACE_Reactor_Mask mask)
{
	ACE_TRACE ("My_ACE_Dev_Poll_Reactor::register_handler");
...
int
My_ACE_Dev_Poll_Reactor::register_handler_i (ACE_HANDLE handle,
										  ACE_Event_Handler *event_handler,
										  ACE_Reactor_Mask mask)
{
	ACE_TRACE ("My_ACE_Dev_Poll_Reactor::register_handler_i");
	...
	if (this->handler_rep_.find (handle) == 0)
	{
		...
		My_Event_Tuple *info = this->handler_rep_.find (handle);
...
int
My_ACE_Dev_Poll_Reactor::register_handler (
...
int
My_ACE_Dev_Poll_Reactor::register_handler (const ACE_Handle_Set &handle_set,
										ACE_Event_Handler *event_handler,
										ACE_Reactor_Mask mask)
{
	ACE_TRACE ("My_ACE_Dev_Poll_Reactor::register_handler");
...
int
My_ACE_Dev_Poll_Reactor::register_handler (int signum,
...
int
My_ACE_Dev_Poll_Reactor::register_handler (const ACE_Sig_Set &sigset,
										ACE_Event_Handler *new_sh,
										ACE_Sig_Action *new_disp)
{
	ACE_TRACE ("My_ACE_Dev_Poll_Reactor::register_handler");
...
int
My_ACE_Dev_Poll_Reactor::remove_handler (ACE_Event_Handler *handler,
									  ACE_Reactor_Mask mask)
{
	ACE_TRACE ("My_ACE_Dev_Poll_Reactor::remove_handler");
...
int
My_ACE_Dev_Poll_Reactor::remove_handler (ACE_HANDLE handle,
									  ACE_Reactor_Mask mask)
{
	ACE_TRACE ("My_ACE_Dev_Poll_Reactor::remove_handler");
...
int
My_ACE_Dev_Poll_Reactor::remove_handler_i (ACE_HANDLE handle,
										ACE_Reactor_Mask mask,
										ACE_Guard<ACE_SYNCH_MUTEX> &repo_guard,
										ACE_Event_Handler *eh)
										// FUZZ: enable check_for_ACE_Guard
{
	ACE_TRACE ("My_ACE_Dev_Poll_Reactor::remove_handler_i");
...
int
My_ACE_Dev_Poll_Reactor::remove_handler (const ACE_Handle_Set &handle_set,
									  ACE_Reactor_Mask mask)
{
	ACE_TRACE ("My_ACE_Dev_Poll_Reactor::remove_handler");
...
int
My_ACE_Dev_Poll_Reactor::remove_handler (int signum,
									  ACE_Sig_Action *new_disp,
									  ACE_Sig_Action *old_disp,
									  int sigkey)
{
...
int
My_ACE_Dev_Poll_Reactor::remove_handler (const ACE_Sig_Set &sigset)
{
	ACE_TRACE ("My_ACE_Dev_Poll_Reactor::remove_handler");
...
int
My_ACE_Dev_Poll_Reactor::suspend_handler (ACE_Event_Handler *event_handler)
{
	ACE_TRACE ("My_ACE_Dev_Poll_Reactor::suspend_handler");
...
int
My_ACE_Dev_Poll_Reactor::suspend_handler (ACE_HANDLE handle)
{
	ACE_TRACE ("My_ACE_Dev_Poll_Reactor::suspend_handler");
...
int
My_ACE_Dev_Poll_Reactor::suspend_handler (const ACE_Handle_Set &handles)
{
	ACE_TRACE ("My_ACE_Dev_Poll_Reactor::suspend_handler");
...
int
My_ACE_Dev_Poll_Reactor::suspend_handlers (void)
{
	ACE_TRACE ("My_ACE_Dev_Poll_Reactor::suspend_handlers");
	...
	{
		My_Event_Tuple *info = this->handler_rep_.find (i);
...
int
My_ACE_Dev_Poll_Reactor::suspend_handler_i (ACE_HANDLE handle)
{
	ACE_TRACE ("My_ACE_Dev_Poll_Reactor::suspend_handler_i");
...
int
My_ACE_Dev_Poll_Reactor::resume_handler (ACE_Event_Handler *event_handler)
{
	ACE_TRACE ("My_ACE_Dev_Poll_Reactor::resume_handler");
...
int
My_ACE_Dev_Poll_Reactor::resume_handler (ACE_HANDLE handle)
{
	ACE_TRACE ("My_ACE_Dev_Poll_Reactor::resume_handler");
...
int
My_ACE_Dev_Poll_Reactor::resume_handler (const ACE_Handle_Set &handles)
{
	ACE_TRACE ("My_ACE_Dev_Poll_Reactor::resume_handler");
...
int
My_ACE_Dev_Poll_Reactor::resume_handlers (void)
{
	ACE_TRACE ("My_ACE_Dev_Poll_Reactor::resume_handlers");
...
int
My_ACE_Dev_Poll_Reactor::resume_handler_i (ACE_HANDLE handle)
{
	ACE_TRACE ("My_ACE_Dev_Poll_Reactor::resume_handler_i");
...
int
My_ACE_Dev_Poll_Reactor::resumable_handler (void)
{
	// @@ Is this correct?
...
bool
My_ACE_Dev_Poll_Reactor::uses_event_associations (void)
{
...
long
My_ACE_Dev_Poll_Reactor::schedule_timer (ACE_Event_Handler *event_handler,
									  const void *arg,
									  const ACE_Time_Value &delay,
									  const ACE_Time_Value &interval)
{
	ACE_TRACE ("My_ACE_Dev_Poll_Reactor::schedule_timer");
...
int
My_ACE_Dev_Poll_Reactor::reset_timer_interval (long timer_id,
											const ACE_Time_Value &interval)
{
	ACE_TRACE ("My_ACE_Dev_Poll_Reactor::reset_timer_interval");
...
int
My_ACE_Dev_Poll_Reactor::cancel_timer (ACE_Event_Handler *event_handler,
									int dont_call_handle_close)
{
	ACE_TRACE ("My_ACE_Dev_Poll_Reactor::cancel_timer");
...
int
My_ACE_Dev_Poll_Reactor::cancel_timer (long timer_id,
									const void **arg,
									int dont_call_handle_close)
{
	ACE_TRACE ("My_ACE_Dev_Poll_Reactor::cancel_timer");
...
int
My_ACE_Dev_Poll_Reactor::schedule_wakeup (ACE_Event_Handler *eh,
									   ACE_Reactor_Mask mask)
{
	ACE_TRACE ("My_ACE_Dev_Poll_Reactor::schedule_wakeup");

	return this->mask_ops (eh->get_handle (), mask, ACE_Reactor::ADD_MASK);
}

int
My_ACE_Dev_Poll_Reactor::schedule_wakeup (ACE_HANDLE handle,
									   ACE_Reactor_Mask mask)
{
	ACE_TRACE ("My_ACE_Dev_Poll_Reactor::schedule_wakeup");
...
int
My_ACE_Dev_Poll_Reactor::cancel_wakeup (ACE_Event_Handler *eh,
									 ACE_Reactor_Mask mask)
{
	ACE_TRACE ("My_ACE_Dev_Poll_Reactor::cancel_wakeup");

	return this->mask_ops (eh->get_handle (), mask, ACE_Reactor::CLR_MASK);
}

int
My_ACE_Dev_Poll_Reactor::cancel_wakeup (ACE_HANDLE handle,
									 ACE_Reactor_Mask mask)
{
	ACE_TRACE ("My_ACE_Dev_Poll_Reactor::cancel_wakeup");
...
int
My_ACE_Dev_Poll_Reactor::notify (ACE_Event_Handler *eh,
							  ACE_Reactor_Mask mask,
							  ACE_Time_Value *timeout)
{
	ACE_TRACE ("My_ACE_Dev_Poll_Reactor::notify");
...
void
My_ACE_Dev_Poll_Reactor::max_notify_iterations (int iterations)
{
	ACE_TRACE ("My_ACE_Dev_Poll_Reactor::max_notify_iterations");
...
int
My_ACE_Dev_Poll_Reactor::max_notify_iterations (void)
{
	ACE_TRACE ("My_ACE_Dev_Poll_Reactor::max_notify_iterations");
...
int
My_ACE_Dev_Poll_Reactor::purge_pending_notifications (ACE_Event_Handler * eh,
												   ACE_Reactor_Mask mask)
{
	if (this->notify_handler_ == 0)
		return 0;
...
ACE_Event_Handler *
My_ACE_Dev_Poll_Reactor::find_handler (ACE_HANDLE handle)
{
...
int
My_ACE_Dev_Poll_Reactor::handler (ACE_HANDLE handle,
							   ACE_Reactor_Mask mask,
							   ACE_Event_Handler **event_handler)
{
	ACE_TRACE ("My_ACE_Dev_Poll_Reactor::handler");
...
int
My_ACE_Dev_Poll_Reactor::handler (int signum,
							   ACE_Event_Handler **eh)
{
	ACE_TRACE ("My_ACE_Dev_Poll_Reactor::handler");
...
bool
My_ACE_Dev_Poll_Reactor::initialized (void)
{
	ACE_TRACE ("My_ACE_Dev_Poll_Reactor::initialized");
...
size_t
My_ACE_Dev_Poll_Reactor::size (void) const
{
	return this->handler_rep_.size ();
}

ACE_Lock &
My_ACE_Dev_Poll_Reactor::lock (void)
{
	ACE_TRACE ("My_ACE_Dev_Poll_Reactor::lock");

	return this->lock_adapter_;
}

void
My_ACE_Dev_Poll_Reactor::wakeup_all_threads (void)
{
	ACE_TRACE ("My_ACE_Dev_Poll_Reactor::wakeup_all_threads");
...
int
My_ACE_Dev_Poll_Reactor::owner (ACE_thread_t /* new_owner */,
							 ACE_thread_t * /* old_owner */)
{
	ACE_TRACE ("My_ACE_Dev_Poll_Reactor::owner");
...
int
My_ACE_Dev_Poll_Reactor::owner (ACE_thread_t * /* owner */)
{
	ACE_TRACE ("My_ACE_Dev_Poll_Reactor::owner");
...
bool
My_ACE_Dev_Poll_Reactor::restart (void)
{
	ACE_TRACE ("My_ACE_Dev_Poll_Reactor::restart");
...
bool
My_ACE_Dev_Poll_Reactor::restart (bool r)
{
	ACE_TRACE ("My_ACE_Dev_Poll_Reactor::restart");
...
void
My_ACE_Dev_Poll_Reactor::requeue_position (int)
{
	ACE_TRACE ("My_ACE_Dev_Poll_Reactor::requeue_position");
}

int
My_ACE_Dev_Poll_Reactor::requeue_position (void)
{
	ACE_TRACE ("My_ACE_Dev_Poll_Reactor::requeue_position");
...
int
My_ACE_Dev_Poll_Reactor::mask_ops (ACE_Event_Handler *event_handler,
								ACE_Reactor_Mask mask,
								int ops)
{
	ACE_TRACE ("My_ACE_Dev_Poll_Reactor::mask_ops");
...
int
My_ACE_Dev_Poll_Reactor::mask_ops (ACE_HANDLE handle,
								ACE_Reactor_Mask mask,
								int ops)
{
	ACE_TRACE ("My_ACE_Dev_Poll_Reactor::mask_ops");
...
int
My_ACE_Dev_Poll_Reactor::mask_ops_i (ACE_HANDLE handle,
								  ACE_Reactor_Mask mask,
								  int ops)
{
	ACE_TRACE ("My_ACE_Dev_Poll_Reactor::mask_ops_i");
...
int
My_ACE_Dev_Poll_Reactor::ready_ops (ACE_Event_Handler * /* event_handler */,
								 ACE_Reactor_Mask /* mask */,
								 int /* ops */)
{
	ACE_TRACE ("My_ACE_Dev_Poll_Reactor::ready_ops");
...
int
My_ACE_Dev_Poll_Reactor::ready_ops (ACE_HANDLE /* handle */,
								 ACE_Reactor_Mask /* mask */,
								 int /* ops */)
{
	ACE_TRACE ("My_ACE_Dev_Poll_Reactor::ready_ops");
...
void
My_ACE_Dev_Poll_Reactor::dump (void) const
{
#if defined (ACE_HAS_DUMP)
	ACE_TRACE ("My_ACE_Dev_Poll_Reactor::dump");
...
short
My_ACE_Dev_Poll_Reactor::reactor_mask_to_poll_event (ACE_Reactor_Mask mask)
{
	ACE_TRACE ("My_ACE_Dev_Poll_Reactor::reactor_mask_to_poll_event");
...
int
My_ACE_Dev_Poll_Reactor::Token_Guard::acquire_quietly (ACE_Time_Value *max_wait)
{
	ACE_TRACE ("My_ACE_Dev_Poll_Reactor::Token_Guard::acquire_quietly");
...
int
My_ACE_Dev_Poll_Reactor::Token_Guard::acquire (ACE_Time_Value *max_wait)
{
	ACE_TRACE ("My_ACE_Dev_Poll_Reactor::Token_Guard::acquire");
