                                        ...
                                        ACE_Time_Value* timeout)
{
    ...
    My_ACE_Dev_Poll_Handler_Guard eh_guard (eh);
...
My_ACE_Dev_Poll_Reactor_Notify::dispatch_notify (ACE_Notification_Buffer& buffer)
{
    ...
    if (buffer.eh_ != 0)
    {
        ...
        My_ACE_Dev_Poll_Handler_Guard eh_guard (buffer.eh_, false);
...
My_ACE_Dev_Poll_Reactor::Event_Tuple*
...

    {
        ...
        */
        ...
        if (eh == this->notify_handler_)
        {
            ...
            if (NULL != dynamic_cast<My_ACE_Dev_Poll_Reactor_Notify*>(notify_handler_))
            {
                status = dynamic_cast<My_ACE_Dev_Poll_Reactor_Notify*>(notify_handler_)->dequeue_one(b);
            }
...
My_ACE_Dev_Poll_Reactor::reactor_mask_to_poll_event (ACE_Reactor_Mask mask)
{
    ...
    {
#if defined (ACE_HAS_EVENT_POLL)
        ACE_SET_BITS (events, EPOLLIN | EPOLLET);
#else
