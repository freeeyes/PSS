...
CPassTCPDlg::CPassTCPDlg(wxWindow* parent,wxWindowID id)
{
    ...
    StaticText6 = new wxStaticText(Panel1, ID_STATICTEXT6, wxT("Lua控制文件路径"), wxPoint(32,188), wxDefaultSize, 0, _T("ID_STATICTEXT6"));
    ...
    Button_LuaAdvance = new wxButton(Panel1, ID_BUTTON_LuaAdvance, wxT("打开文件夹"), wxPoint(144,208), wxDefaultSize, 0, wxDefaultValidator, _T("ID_BUTTON_LuaAdvance"));
    Button_StatTest = new wxButton(Panel1, ID_BUTTON_StatTest, wxT("开始压测"), wxPoint(32,252), wxDefaultSize, 0, wxDefaultValidator, _T("ID_BUTTON_StatTest"));
    Button_StopTest = new wxButton(Panel1, ID_BUTTON_StopTest, wxT("停止压测"), wxPoint(200,252), wxDefaultSize, 0, wxDefaultValidator, _T("ID_BUTTON_StopTest"));
    Button_ExportTestData = new wxButton(Panel1, ID_BUTTON_ExportTestData, wxT("导出压测数据文档"), wxPoint(352,252), wxDefaultSize, 0, wxDefaultValidator, _T("ID_BUTTON_ExportTestData"));
    Button_SetRadomPacket = new wxButton(Panel1, ID_BUTTON_SetRadomPacket, wxT("设置随机数据包序列"), wxPoint(528,252), wxDefaultSize, 0, wxDefaultValidator, _T("ID_BUTTON_SetRadomPacket"));
