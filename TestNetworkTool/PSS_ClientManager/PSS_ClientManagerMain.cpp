...
PSS_ClientManagerFrame::PSS_ClientManagerFrame(wxWindow* parent,wxWindowID id)
{
    ...
    Create(parent, wxID_ANY, wxT("PSS_ClientManager"), wxDefaultPosition, wxDefaultSize, wxDEFAULT_DIALOG_STYLE|wxMINIMIZE_BOX, _T("wxID_ANY"));
    SetClientSize(wxSize(923,506));
    {
    	wxIcon FrameIcon;
    ...
    TextCtrl_ServerPort = new wxTextCtrl(Panel1, ID_TEXTCTRL3, wxT("10010"), wxPoint(284,32), wxSize(114,35), 0, wxDefaultValidator, _T("ID_TEXTCTRL3"));
    ...
    ListBox_ConfigList->SetSelection( ListBox_ConfigList->Append(_("Windows PSS")) );
    ListBox_ConfigList->Append(_("Linux PSS"));
    ...
    ListCtrl_ModuleList = new wxListCtrl(Panel1, ID_LISTCTRL1, wxPoint(16,344), wxSize(736,112), wxLC_REPORT|wxLC_SINGLE_SEL|wxBORDER_STATIC, wxDefaultValidator, _T("ID_LISTCTRL1"));
    ...
    StaticText8 = new wxStaticText(Panel2, ID_STATICTEXT8, wxT("当前链接数量"), wxPoint(210,40), wxDefaultSize, 0, _T("ID_STATICTEXT8"));
    TextCtrl_CurrClientCount = new wxTextCtrl(Panel2, ID_TEXTCTRL8, wxEmptyString, wxPoint(296,36), wxDefaultSize, 0, wxDefaultValidator, _T("ID_TEXTCTRL8"));
    ...
    TextCtrl_CurrFlowIn = new wxTextCtrl(Panel2, ID_TEXTCTRL9, wxEmptyString, wxPoint(496,36), wxDefaultSize, 0, wxDefaultValidator, _T("ID_TEXTCTRL9"));
    ...
    TextCtrl_CurrFlowOut = new wxTextCtrl(Panel2, ID_TEXTCTRL10, wxEmptyString, wxPoint(696,36), wxDefaultSize, 0, wxDefaultValidator, _T("ID_TEXTCTRL10"));
    TextCtrl_CurrFlowOut->Disable();
    Button_SetLinkLimit = new wxButton(Panel2, ID_BUTTON10, wxT("重新设置上限"), wxPoint(32,72), wxSize(152,34), 0, wxDefaultValidator, _T("ID_BUTTON10"));
    StaticText11 = new wxStaticText(Panel2, ID_STATICTEXT11, wxT("链接总数上限"), wxPoint(210,80), wxDefaultSize, 0, _T("ID_STATICTEXT11"));
    TextCtrl_LinkUpperLimit = new wxTextCtrl(Panel2, ID_TEXTCTRL11, wxEmptyString, wxPoint(296,76), wxDefaultSize, 0, wxDefaultValidator, _T("ID_TEXTCTRL11"));
    ...
    RadioBox_DebugState = new wxRadioBox(Panel2, ID_RADIOBOX1, wxEmptyString, wxPoint(144,106), wxDefaultSize, 2, __wxRadioBoxChoices_1, 1, wxRA_VERTICAL|wxBORDER_NONE, wxDefaultValidator, _T("ID_RADIOBOX1"));
    ...
    TextCtrl_CurrDebugStat = new wxTextCtrl(Panel2, ID_TEXTCTRL12, wxEmptyString, wxPoint(616,116), wxDefaultSize, 0, wxDefaultValidator, _T("ID_TEXTCTRL12"));
    ...
    TextCtrl_CurrCpuOccupy = new wxTextCtrl(Panel2, ID_TEXTCTRL13, wxEmptyString, wxPoint(136,204), wxDefaultSize, 0, wxDefaultValidator, _T("ID_TEXTCTRL13"));
    ...
    TextCtrl_CurrMemOccupy = new wxTextCtrl(Panel2, ID_TEXTCTRL14, wxEmptyString, wxPoint(360,204), wxDefaultSize, 0, wxDefaultValidator, _T("ID_TEXTCTRL14"));
    ...
    ListCtrl_LinkHistory = new wxListCtrl(Panel2, ID_LISTCTRL2, wxPoint(24,320), wxSize(776,120), wxLC_REPORT|wxLC_SINGLE_SEL|wxBORDER_STATIC, wxDefaultValidator, _T("ID_LISTCTRL2"));
    ...
    TextCtrl_ModuleID = new wxTextCtrl(Panel3, ID_TEXTCTRL16, wxEmptyString, wxPoint(88,36), wxDefaultSize, 0, wxDefaultValidator, _T("ID_TEXTCTRL16"));
    ...
    ListCtrl_ModuleInfo = new wxListCtrl(Panel3, ID_LISTCTRL3, wxPoint(24,80), wxSize(792,168), wxLC_REPORT|wxLC_SINGLE_SEL|wxBORDER_STATIC, wxDefaultValidator, _T("ID_LISTCTRL3"));
    ...
    ListCtrl_CommandTimeout = new wxListCtrl(Panel3, ID_LISTCTRL4, wxPoint(24,304), wxSize(792,144), wxLC_REPORT|wxLC_SINGLE_SEL|wxBORDER_STATIC, wxDefaultValidator, _T("ID_LISTCTRL4"));
    ...
    TextCtrl_ClientID = new wxTextCtrl(Panel4, ID_TEXTCTRL17, wxEmptyString, wxPoint(168,28), wxDefaultSize, 0, wxDefaultValidator, _T("ID_TEXTCTRL17"));
    ...
    ListCtrl_ClientTcpInfo = new wxListCtrl(Panel4, ID_LISTCTRL5, wxPoint(24,64), wxSize(792,192), wxLC_REPORT|wxLC_SINGLE_SEL|wxBORDER_STATIC, wxDefaultValidator, _T("ID_LISTCTRL5"));
    StaticText19 = new wxStaticText(Panel4, ID_STATICTEXT19, wxT("当前日志等级"), wxPoint(16,272), wxDefaultSize, 0, _T("ID_STATICTEXT19"));
    TextCtrl_LogLevel = new wxTextCtrl(Panel4, ID_TEXTCTRL18, wxT("1"), wxPoint(112,268), wxDefaultSize, 0, wxDefaultValidator, _T("ID_TEXTCTRL18"));
    ...
    ListCtrl_LogInfo = new wxListCtrl(Panel4, ID_LISTCTRL6, wxPoint(24,312), wxSize(792,136), wxLC_REPORT|wxLC_SINGLE_SEL|wxBORDER_STATIC, wxDefaultValidator, _T("ID_LISTCTRL6"));
    ...
    ListCtrl_WorkThreadInfo = new wxListCtrl(Panel5, ID_LISTCTRL7, wxPoint(24,72), wxSize(808,160), wxLC_REPORT|wxLC_SINGLE_SEL|wxBORDER_STATIC, wxDefaultValidator, _T("ID_LISTCTRL7"));
    ...
    TextCtrl_ThreadCount = new wxTextCtrl(Panel5, ID_TEXTCTRL19, wxT("3"), wxPoint(128,260), wxDefaultSize, 0, wxDefaultValidator, _T("ID_TEXTCTRL19"));
    StaticText21 = new wxStaticText(Panel5, ID_STATICTEXT21, wxT("检查间隔"), wxPoint(244,264), wxDefaultSize, 0, _T("ID_STATICTEXT21"));
    TextCtrl_CheckTime = new wxTextCtrl(Panel5, ID_TEXTCTRL20, wxT("60"), wxPoint(304,260), wxDefaultSize, 0, wxDefaultValidator, _T("ID_TEXTCTRL20"));
    StaticText22 = new wxStaticText(Panel5, ID_STATICTEXT22, wxT("秒"), wxPoint(418,264), wxDefaultSize, 0, _T("ID_STATICTEXT22"));
    ...
    ListCtrl_CheckLog = new wxListCtrl(Panel5, ID_LISTCTRL8, wxPoint(24,296), wxSize(448,152), wxLC_REPORT|wxLC_SINGLE_SEL|wxBORDER_STATIC, wxDefaultValidator, _T("ID_LISTCTRL8"));
    wxString __wxRadioBoxChoices_2[2] =
    {
    	_("监控当前服务器"),
    	_("监控列表服务器")
    };
    RadioBox_MonitorServer = new wxRadioBox(Panel5, ID_RADIOBOX2, wxEmptyString, wxPoint(480,282), wxSize(336,48), 2, __wxRadioBoxChoices_2, 1, wxRA_VERTICAL|wxBORDER_NONE, wxDefaultValidator, _T("ID_RADIOBOX2"));
    RadioBox_MonitorServer->SetSelection(0);
    ListCtrl_ServerList = new wxListCtrl(Panel5, ID_LISTCTRL9, wxPoint(480,336), wxSize(344,72), wxLC_REPORT|wxLC_SINGLE_SEL|wxBORDER_STATIC, wxDefaultValidator, _T("ID_LISTCTRL9"));
    ...
    Button_ReconnectServer = new wxButton(Panel6, ID_BUTTON31, wxT("重新连接"), wxPoint(200,70), wxDefaultSize, 0, wxDefaultValidator, _T("ID_BUTTON31"));
    ListCtrl_ServerConnect = new wxListCtrl(Panel6, ID_LISTCTRL10, wxPoint(16,112), wxSize(824,136), wxLC_REPORT|wxLC_SINGLE_SEL|wxBORDER_STATIC, wxDefaultValidator, _T("ID_LISTCTRL10"));
    ListCtrl_ServerLisen = new wxListCtrl(Panel6, ID_LISTCTRL11, wxPoint(16,296), wxSize(328,136), wxLC_REPORT|wxLC_SINGLE_SEL|wxBORDER_STATIC, wxDefaultValidator, _T("ID_LISTCTRL11"));
    ...
    TextCtrl_LisenIP = new wxTextCtrl(Panel6, ID_TEXTCTRL22, wxEmptyString, wxPoint(456,284), wxDefaultSize, 0, wxDefaultValidator, _T("ID_TEXTCTRL22"));
    TextCtrl_LisenIP->SetMaxLength(16);
    TextCtrl_LisenPort = new wxTextCtrl(Panel6, ID_TEXTCTRL23, wxT("0"), wxPoint(456,324), wxDefaultSize, 0, wxDefaultValidator, _T("ID_TEXTCTRL23"));
    ...
    TextCtrl_PacketParseID = new wxTextCtrl(Panel6, ID_TEXTCTRL24, wxEmptyString, wxPoint(688,324), wxDefaultSize, 0, wxDefaultValidator, _T("ID_TEXTCTRL24"));
    ComboBox_ListenType = new wxComboBox(Panel6, ID_COMBOBOX1, wxEmptyString, wxPoint(456,364), wxSize(112,25), 0, 0, 0, wxDefaultValidator, _T("ID_COMBOBOX1"));
    ComboBox_ListenType->SetSelection( ComboBox_ListenType->Append(_("IPv4")) );
    ComboBox_ListenType->Append(_("IPv6"));
    ...
    StaticBox11 = new wxStaticBox(Panel7, ID_STATICBOX11, wxT("IP封禁管理"), wxPoint(8,0), wxSize(792,440), 0, _T("ID_STATICBOX11"));
    StaticText28 = new wxStaticText(Panel7, ID_STATICTEXT28, wxT("要封禁的IP地址(支持*)"), wxPoint(24,28), wxDefaultSize, 0, _T("ID_STATICTEXT28"));
    TextCtrl_ForbidenIP = new wxTextCtrl(Panel7, ID_TEXTCTRL25, wxEmptyString, wxPoint(160,24), wxDefaultSize, 0, wxDefaultValidator, _T("ID_TEXTCTRL25"));
    TextCtrl_ForbidenIP->SetMaxLength(16);
    StaticText29 = new wxStaticText(Panel7, ID_STATICTEXT29, wxT("要封禁的秒数"), wxPoint(312,28), wxDefaultSize, 0, _T("ID_STATICTEXT29"));
    TextCtrl_ForbidenSeconds = new wxTextCtrl(Panel7, ID_TEXTCTRL26, wxEmptyString, wxPoint(400,24), wxDefaultSize, 0, wxDefaultValidator, _T("ID_TEXTCTRL26"));
    wxString __wxRadioBoxChoices_3[2] =
    {
    	_("时段封禁"),
    	_("永久封禁")
    };
    RadioBoxm_TimeForbiden = new wxRadioBox(Panel7, ID_RADIOBOX3, wxEmptyString, wxPoint(536,6), wxSize(240,50), 2, __wxRadioBoxChoices_3, 1, wxRA_VERTICAL|wxBORDER_NONE, wxDefaultValidator, _T("ID_RADIOBOX3"));
    RadioBoxm_TimeForbiden->SetSelection(0);
    Button_InsertForbiden = new wxButton(Panel7, ID_BUTTON35, wxT("添加封禁"), wxPoint(24,64), wxDefaultSize, 0, wxDefaultValidator, _T("ID_BUTTON35"));
    Button_ReleaseForbiden = new wxButton(Panel7, ID_BUTTON36, wxT("解除封禁"), wxPoint(144,64), wxDefaultSize, 0, wxDefaultValidator, _T("ID_BUTTON36"));
    Button_ShowForbiden = new wxButton(Panel7, ID_BUTTON37, wxT("查看列表"), wxPoint(264,64), wxDefaultSize, 0, wxDefaultValidator, _T("ID_BUTTON37"));
    ListCtrl_ForbidenList = new wxListCtrl(Panel7, ID_LISTCTRL12, wxPoint(24,104), wxSize(768,160), wxLC_REPORT|wxLC_SINGLE_SEL|wxBORDER_STATIC, wxDefaultValidator, _T("ID_LISTCTRL12"));
    StaticText30 = new wxStaticText(Panel7, ID_STATICTEXT30, wxT("要查看的连接别名"), wxPoint(24,280), wxDefaultSize, 0, _T("ID_STATICTEXT30"));
    StaticText31 = new wxStaticText(Panel7, ID_STATICTEXT31, wxT("ConnectID"), wxPoint(24,312), wxDefaultSize, 0, _T("ID_STATICTEXT31"));
    TextCtrl_NickName = new wxTextCtrl(Panel7, ID_TEXTCTRL27, wxEmptyString, wxPoint(128,276), wxDefaultSize, 0, wxDefaultValidator, _T("ID_TEXTCTRL27"));
    TextCtrl_ConnectID = new wxTextCtrl(Panel7, ID_TEXTCTRL28, wxEmptyString, wxPoint(128,308), wxDefaultSize, 0, wxDefaultValidator, _T("ID_TEXTCTRL28"));
    Button_SearchNickname = new wxButton(Panel7, ID_BUTTON38, wxT("查询别名"), wxPoint(264,272), wxDefaultSize, 0, wxDefaultValidator, _T("ID_BUTTON38"));
    Button_OpenLog = new wxButton(Panel7, ID_BUTTON39, wxT("打开日志"), wxPoint(264,312), wxDefaultSize, 0, wxDefaultValidator, _T("ID_BUTTON39"));
    Button_Closelog = new wxButton(Panel7, ID_BUTTON40, wxT("关闭日志"), wxPoint(360,312), wxDefaultSize, 0, wxDefaultValidator, _T("ID_BUTTON40"));
    ListCtrl_NickInfo = new wxListCtrl(Panel7, ID_LISTCTRL13, wxPoint(24,352), wxSize(768,104), wxLC_REPORT|wxLC_SINGLE_SEL|wxBORDER_STATIC, wxDefaultValidator, _T("ID_LISTCTRL13"));
    ...
    ListCtrl_TrackIPHistory = new wxListCtrl(Panel8, ID_LISTCTRL14, wxPoint(8,200), wxSize(816,256), wxLC_REPORT|wxLC_SINGLE_SEL|wxBORDER_STATIC, wxDefaultValidator, _T("ID_LISTCTRL14"));
    ...
    Button_GetTrackSourceIP = new wxButton(Panel8, ID_BUTTON41, wxT("查询IP来源"), wxPoint(304,32), wxSize(96,35), 0, wxDefaultValidator, _T("ID_BUTTON41"));
    ...
    Button_SetTrackCommandID = new wxButton(Panel8, ID_BUTTON42, wxT("设置CommandID"), wxPoint(560,112), wxSize(128,35), 0, wxDefaultValidator, _T("ID_BUTTON42"));
    ...
    ListCtrl_WorkThreadAI = new wxListCtrl(Panel9, ID_LISTCTRL15, wxPoint(16,40), wxSize(600,184), wxLC_REPORT|wxLC_SINGLE_SEL|wxBORDER_STATIC, wxDefaultValidator, _T("ID_LISTCTRL15"));
    ...
    ListCtr_WorkThreadTimeout = new wxListCtrl(Panel9, ID_LISTCTRL16, wxPoint(16,264), wxSize(408,184), wxLC_REPORT|wxLC_SINGLE_SEL|wxBORDER_STATIC, wxDefaultValidator, _T("ID_LISTCTRL16"));
    ListCtrl_WorkThreadForbiden = new wxListCtrl(Panel9, ID_LISTCTRL17, wxPoint(440,264), wxSize(280,184), wxLC_REPORT|wxLC_SINGLE_SEL|wxBORDER_STATIC, wxDefaultValidator, _T("ID_LISTCTRL17"));
...
void PSS_ClientManagerFrame::OnTextCtrl_CurrFlowInText(wxCommandEvent& event)
{
}
