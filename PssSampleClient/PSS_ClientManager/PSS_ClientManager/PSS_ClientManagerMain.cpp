...
PSS_ClientManagerFrame::PSS_ClientManagerFrame(wxWindow* parent,wxWindowID id)
{
    ...
    ListCtrl_ModuleList = new wxListCtrl(Panel1, ID_LISTCTRL1, wxPoint(16,344), wxSize(736,112), wxLC_LIST|wxLC_REPORT|wxLC_SINGLE_SEL, wxDefaultValidator, _T("ID_LISTCTRL1"));
    ...
    ListCtrl_LinkHistory = new wxListCtrl(Panel2, ID_LISTCTRL2, wxPoint(24,320), wxSize(776,120), wxLC_LIST|wxLC_REPORT, wxDefaultValidator, _T("ID_LISTCTRL2"));
    ...
    ListCtrl_ModuleInfo = new wxListCtrl(Panel3, ID_LISTCTRL3, wxPoint(24,80), wxSize(792,168), wxLC_LIST|wxLC_REPORT, wxDefaultValidator, _T("ID_LISTCTRL3"));
    ...
    ListCtrl_CommandTimeout = new wxListCtrl(Panel3, ID_LISTCTRL4, wxPoint(24,304), wxSize(792,144), wxLC_LIST|wxLC_REPORT, wxDefaultValidator, _T("ID_LISTCTRL4"));
    ...
    ListCtrl_ClientTcpInfo = new wxListCtrl(Panel4, ID_LISTCTRL5, wxPoint(24,64), wxSize(792,192), wxLC_LIST|wxLC_REPORT, wxDefaultValidator, _T("ID_LISTCTRL5"));
    ...
    ListCtrl_LogInfo = new wxListCtrl(Panel4, ID_LISTCTRL6, wxPoint(24,312), wxSize(792,136), wxLC_LIST|wxLC_REPORT, wxDefaultValidator, _T("ID_LISTCTRL6"));
    ...
    ListCtrl_WorkThreadInfo = new wxListCtrl(Panel5, ID_LISTCTRL7, wxPoint(24,72), wxSize(808,160), wxLC_LIST|wxLC_REPORT, wxDefaultValidator, _T("ID_LISTCTRL7"));
    ...
    ListCtrl_CheckLog = new wxListCtrl(Panel5, ID_LISTCTRL8, wxPoint(24,296), wxSize(448,152), wxLC_LIST|wxLC_REPORT, wxDefaultValidator, _T("ID_LISTCTRL8"));
    ...
    ListCtrl_ServerList = new wxListCtrl(Panel5, ID_LISTCTRL9, wxPoint(480,336), wxSize(344,72), wxLC_LIST|wxLC_REPORT, wxDefaultValidator, _T("ID_LISTCTRL9"));
    ...
    ListCtrl_ServerConnect = new wxListCtrl(Panel6, ID_LISTCTRL10, wxPoint(16,112), wxSize(824,136), wxLC_LIST|wxLC_REPORT, wxDefaultValidator, _T("ID_LISTCTRL10"));
    ListCtrl_ServerLisen = new wxListCtrl(Panel6, ID_LISTCTRL11, wxPoint(16,296), wxSize(328,136), wxLC_LIST|wxLC_REPORT, wxDefaultValidator, _T("ID_LISTCTRL11"));
    ...
    ListCtrl_ForbidenList = new wxListCtrl(Panel7, ID_LISTCTRL12, wxPoint(24,136), wxSize(768,128), wxLC_LIST|wxLC_REPORT, wxDefaultValidator, _T("ID_LISTCTRL12"));
    ...
    ListCtrl_NickInfo = new wxListCtrl(Panel7, ID_LISTCTRL13, wxPoint(16,352), wxSize(776,104), wxLC_LIST|wxLC_REPORT, wxDefaultValidator, _T("ID_LISTCTRL13"));
    ...
    ListCtrl_TrackIPHistory = new wxListCtrl(Panel8, ID_LISTCTRL14, wxPoint(8,200), wxSize(816,256), wxLC_LIST|wxLC_REPORT, wxDefaultValidator, _T("ID_LISTCTRL14"));
    ...
    ListCtrl_WorkThreadAI = new wxListCtrl(Panel9, ID_LISTCTRL15, wxPoint(16,40), wxSize(600,184), wxLC_LIST|wxLC_REPORT|wxLC_SINGLE_SEL, wxDefaultValidator, _T("ID_LISTCTRL15"));
    ...
    ListCtr_WorkThreadTimeout = new wxListCtrl(Panel9, ID_LISTCTRL16, wxPoint(16,264), wxSize(408,184), wxLC_LIST|wxLC_REPORT|wxLC_SINGLE_SEL, wxDefaultValidator, _T("ID_LISTCTRL16"));
    ListCtrl_WorkThreadForbiden = new wxListCtrl(Panel9, ID_LISTCTRL17, wxPoint(440,264), wxSize(280,184), wxLC_LIST|wxLC_REPORT|wxLC_SINGLE_SEL, wxDefaultValidator, _T("ID_LISTCTRL17"));
...
void PSS_ClientManagerFrame::ShowConfigList()
{
    ...
    if  (m_vecConfigInfo.size() >0) this->ListBox_ConfigList->SetSelection(0);
